...
if __name__ == "__main__":
    ...
    filtered_cloud = interpolate_within_clusters(filtered_cloud, eps=0.5, min_points=10, num_interpolated_points_per_cluster=1000)
    ...
    o3d.io.write_point_cloud("saved_scenes/clustered_interpolated_scene.ply", combined_cloud)
